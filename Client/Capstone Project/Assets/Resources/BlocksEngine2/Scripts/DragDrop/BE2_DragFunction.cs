...
public class BE2_DragFunction : MonoBehaviour, I_BE2_Drag
{
    ...
    IEnumerator DetectSpotOnEndOfFrame()
    {
        ...
        Debug.Log($"Transform {Transform.ToString()}  _dragDropManager.DraggedObjectsTransform.name {_dragDropManager.DraggedObjectsTransform.name}");
