...
public class BE2_Block : MonoBehaviour, I_BE2_Block
{
    ...
    void Start()
    {
        ...
        GetParentSection();
        BE2_MainEventsManager.Instance.StartListening(BE2EventTypes.OnPointerUpEnd, GetParentSection);
    }

    void OnDisable()
    {
        BE2_MainEventsManager.Instance.StopListening(BE2EventTypes.OnPointerUpEnd, GetParentSection);
    }
